...
const Skills = () => {
  ...
  <div>
        <div className='w-full flex flex-col py-20'>
            ...
            mb-10 text-center'>Technical Skills</h4>
                ...
                {skills.map((skill,index) => (
                        ...
                        rounded-full items-center hover:animate-bounce ease-in-out duration-300'>
                            <div className='w-10 h-10'>
                                <img src={skill.icon} alt="" className='w-full h-full rounded-full'/>
                            </div>
                            <div className='flex flex-col gap-1'>
                                ...
                                <div className='w-[200px] h-[10px] bg-slate-800 eounded-lg mb-1'>
        ...
        <div className='mt-[10rem'>
                ...
                <div className='flex flex-col md:flex-row gap-16 items-center justify-center'>
                    <div className='flex flex-col bg-[#000000] dark:bg-[#224cff10] p-6 rounded-xl shadow-xl scale-110
                    ...
                    <div className='flex flex-col bg-[#000000] dark:bg-[#224cff10] p-6 rounded-xl shadow-xl scale-110 hover:scale-125 ease-in-out duration-500
                    mb-10 md:mb-0'>
